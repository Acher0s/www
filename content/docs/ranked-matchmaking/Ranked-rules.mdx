---
title: Ranked Rules
description: Learn about the ranked rules in Balatro Multiplayer
---

## Rules

- All games must be played on the ranked ruleset
...
- You must be on the latest version of Multiplayer
- You must not be using any banned mods
    - [Approved mods](/docs/multiplayer-content/approved-mods) and [banned mods](/docs/multiplayer-content/banned-mods) lists
...
- You have to be on the recommended steammodded (711a). Not doing so will result in a strike or win given to your opponent. The easiest way to get the recommended steammodded is through the [Balatro Multiplayer Launcher](https://balatromp.com/docs/getting-started/installation), or through manually downloading it.
You can download the recommended steammodded can be found [In this download link,](https://github.com/Steamodded/smods/archive/refs/tags/1.0.0-beta-0711a.zip)

## Queue rules

- All games are played on the Ranked ruleset
- If there are any problems in your queue match, such as someone not voting, or someone not responding then please use the call helpers button for assistance **in queue**
- If a player crashes or disconnects then we follow this policy in terms of resolving the result of the game:
    ...
    - If a player is found to not be following this policy then please use the Call Helpers button
...
## Queue Etiquette
- Both players have use the banning system or reach an agreement to determine the deck and stake for a match.
